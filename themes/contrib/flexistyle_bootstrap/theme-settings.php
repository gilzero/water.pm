...
/**
 * @file
 * Theme settings form for FlexiStyle Bootstrap theme.
 */
 ...
 */
function flexistyle_bootstrap_form_system_theme_settings_alter(array &$form, FormState $form_state): void {
  ...
  $form['flexistyle_bootstrap_tabs'] = [
    '#type' => 'vertical_tabs',
    '#prefix' => '<h2><small>' . t('FlexiStyle Bootstrap Settings') . '</small></h2>',
    '#weight' => -10,
  ];
  ...
  $form['flexi_bootstrap']['bootstrap'] = [
    '#type' => 'select',
  ...
  $form['flexi_bootstrap']['bootstrap_cdn'] = [
    '#type' => 'select',
    '#title' => t('Bootstrap From CDN'),
    '#default_value' => theme_get_setting('bootstrap_cdn'),
    '#options' => $bootstrap_versions,
    '#states' => [
      'visible' => [
        [':input[name="bootstrap"]' => ['value' => 'cdn']],
      ],
    ],
  ];
  $form['flexi_bootstrap']['bootstrap_local'] = [
    '#type' => 'select',
    '#title' => t('Bootstrap From Local'),
    '#default_value' => theme_get_setting('bootstrap_local'),
    '#options' => $bootstrap_versions,
    '#states' => [
      'visible' => [
        [':input[name="bootstrap"]' => ['value' => 'local']],
      ],
    ],
  ];
