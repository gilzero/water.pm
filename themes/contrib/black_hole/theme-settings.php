...
/**
 * @file
 * Functions to support Black Hole theme settings.
 */
...
use Drupal\Core\Form\FormStateInterface;
  ...
  */
function black_hole_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
...
// ### Slideshow ###
  ...
  $form['slideshow']['slideshow_all'] = array(
    ...
    '#markup' => t('<sup>To update the slide images, you can select from preloaded images in the "_custom/sliderimg" folder of the theme or from any other folder or server. The <b>Image URL</b> must be formatted as "/themes/contrib/black_hole/_custom/sliderimg/IMAGE" or "//otherserver.com/IMAGE". The slides are language-aware, and the <b>Slide URL</b> can point to Home (if left blank) or internal pages ("node/NODE_NUMBER").</sup>'),
  );
...
// ### Other settings ###
  ...
  $form['themedev']['intl_logo']['intl_logo_path'] = array(
    ...
    '#description' => t('The folder where the logo images are kept must be specified here, such as "/themes/contrib/black_hole/_custom/logos" or "//otherserver.com/FOLDER"'),
